...
2. **lessons_photo** 
   В папке lesssons_photo хранятся все изображения, используемые в разделе "Уроки" 
   
   В папке хранятся изображения, относящиеся к уроку "Древний мир"
   ...
   * *anc_china* - изображения Древнего Китая
   * *coleseum.webp* - изображение Колизея
   * *columb.webp* - изображение Колумба
   * *cristiane_life.webp* - изображение сцены жизни крестьян
   * *england_fight.webp* - изображение сражения в Англии
   * *feodal_zamok* - изображение феодального замка
   * *gal.webp* - изображение Галлипольской операции
   * *ger_pol.webp* - изображение нападения Германии на Польшу
...
___
   * *Lesson* - общий класс для уроков
      ###### Методы класса:
        * init - инициализация
___
   * *UsefulMaterial* - класс, реализующий окно раздела *Полезные материалы* в **Учебнике**
      ###### Методы класса:
        * init - инициализация
        * open_first_article - открывает вкладку в браузере с первой статьей
        * open_second_article - открывает вкладку в браузере со второй статьей
        * open_third_article - открывает вкладку в браузере с третьей статьей
        * open_fourth_article - открывает вкладку в браузере с четвертой статьей
        * open_fifth_article - открывает вкладку в браузере с пятой статьей
        * open_sixth_article - открывает вкладку в браузере с шестой статьей
        * return_back - возвращает в раздел Учебник
___
   **Классы: ModernWorldFirstLesson, TwentyCenturySecondLesson, TwentyCenturyFirstLesson, NewEraFirstLesson, RevivalSecondLesson, RevivalFirstLesson, MiddleAgesFirstLesson, MiddleAgesSecondLesson, AncientFirstLesson, AncientSecondLesson, AncientThirdLesson** - классы окон уроков разных эпох. Все унаследованы от класса Lesson. 

   Методы классов:
   
   * init - инициализация 
   * return_back - выйти в раздел Эпохи
   * open_next_lesson - открыть следующий урок
   * open_previous_lesson - открыть прошлый урок
___
