...
class Ui_TwentyCentury(object):
    def setupUi(self, TwentyCentury):
        TwentyCentury.setObjectName("TwentyCentury")
        TwentyCentury.resize(949, 759)
        self.centralwidget = QtWidgets.QWidget(parent=TwentyCentury)
        ...
        TwentyCentury.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=TwentyCentury)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 949, 26))
        self.menubar.setObjectName("menubar")
        TwentyCentury.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=TwentyCentury)
        self.statusbar.setObjectName("statusbar")
        TwentyCentury.setStatusBar(self.statusbar)
        ...
        self.retranslateUi(TwentyCentury)
        QtCore.QMetaObject.connectSlotsByName(TwentyCentury)

    def retranslateUi(self, TwentyCentury):
        _translate = QtCore.QCoreApplication.translate
        TwentyCentury.setWindowTitle(_translate("TwentyCentury", "TwentyCentury"))
        self.first_lesson.setText(_translate("TwentyCentury", "Урок 1. Первая Мировая Война"))
        self.second_lesson.setText(_translate("TwentyCentury", "Урок 2. Вторая Мировая Война"))
        self.third_lesson.setText(_translate("TwentyCentury", "Урок 3. Деколонизация и движение за права человека"))
        self.ancient_label.setText(_translate("TwentyCentury", "XX век"))
        self.return_button.setText(_translate("TwentyCentury", "Вернуться назад"))