...
class Ui_RevivalEra(object):
    ...
    def retranslateUi(self, RevivalEra):
        ...
        self.first_lesson.setText(_translate("RevivalEra", "Урок 1. Возрождение в Европе: искусство, наука, литература"))
        self.second_lesson.setText(_translate("RevivalEra", "Урок 2. Реформация и её влияние на религию и общество"))
        self.third_lesson.setText(_translate("RevivalEra", "Урок 3. Начало колонизации и глобализации"))
